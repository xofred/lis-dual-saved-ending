...
SECTIONS_S3 = [
    ...
    ("舊金山七日壯遊",       110, 114, "沒有 Wi-Fi 的正宗塔可店與街頭陰影裡的被遺忘者、FAA 全線停飛逼出的私人候機室佔領、宿醉早餐引爆的階級飲食內戰,以及不知為何如期舉行的反劫機 4D 真人秀"),
    ("聖誕節與洗衣機大戰",   115, 126, "紅藍警燈與過節話題各自埋下一根刺、聖誕送禮三部曲(血汗小熊、貴族縫紉機事故、回禮恐慌症)、洗衣機災難升級成微觀駭客報復戰,直到深夜潛入物流基地的機器狗生死追逐"),
    ("家族信託風暴",         127, 9999, "Max 未雨綢繆拍下的全家福保險存檔、Chase 家族祖父的越洋來電正式引爆 ── 第三季還沒完結,這段留給後續新章節自動歸入"),
]
